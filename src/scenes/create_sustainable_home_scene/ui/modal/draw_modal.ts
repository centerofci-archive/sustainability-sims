...
export function draw_modal (ui_layer: AdvancedDynamicTexture, title: string): ModalReturn
{
    ...
    const title_text = new TextBlock()
    ...
    const inner_content = new Rectangle()
