...
const home2_annual_gas_bill_2019: TemporalRangeValue = {
...
const home2_gas_bill_2022_feb__gbp: TemporalRangeValue = {
...
const home2_gas_usage_2022_feb__m3: TemporalRangeValue = {
    value: 386,
...
const home2_annual_2019_gas_usage__therm: TemporalRangeValue = {
...
const home2_annual_2019_gas_usage__m3: TemporalRangeValue = {
    ...value_or_raise(convert_value(home2_annual_2019_gas_usage__therm, UnitsID.volume_normal_m3)),
    description: "Estimate based off 2019 estimate of estimated gas bill with calculation of therms given average uk gas price",
}

const home2_annual_2022_gas_usage__m3: TemporalRangeValue = {
...
export const home2_annual_gas_usage__m3 = [
    home2_annual_2019_gas_usage__m3,
    home2_annual_2022_gas_usage__m3,
]
